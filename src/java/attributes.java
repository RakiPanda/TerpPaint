 ...
 * attributes.java
 *
 * Created on February 10, 2003, 5:03 PM
 */
// ming 4.26
...
public class attributes extends javax.swing.JDialog {
	...
	public attributes(java.awt.Frame parent, boolean modal) {
		...
		if (((TerpPaint) this.getParent()).grayscaleFlag == 0) {
...
//		blackwhite.setText("black and white");
	...
	public void okActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (currWidth * currHeight >= 3000000) {
			...
			// ming 4.22
			if (old_width != (int) (newPixW + 0.5)
					|| old_height != (int) (newPixH + 0.5)) {
				// ming 4.24
				...
				if (lastSelected == 1)
					((TerpPaint) this.getParent()).center.resizeImage(
				...
				((TerpPaint) this.getParent()).center.setZoom(((TerpPaint) this.getParent()).center.getZoom());
			}
			// ming 4.22 end
			...
			/*	  {
			 ...
			 ((TerpPaint)this.getParent()).action_list.add("Change size");
			 ((TerpPaint)this.getParent()).updateUndoList();
			 }*/
			// ming 4.22 end
			im = ((TerpPaint) this.getParent()).center.getBufferedImage();
			// ming 4.22
			boolean cur_grayscale = ((TerpPaint) this.getParent()).center
					.getGrayscale();
			...
			if (!cur_grayscale && blackwhite.isSelected()) {
				...
				//    if ( ((TerpPaint)this.getParent()).grayscaleFlag == 0 ){
				// ming 4.4 end
				BufferedImage gray = new BufferedImage(im.getWidth(), im
						.getHeight(), BufferedImage.TYPE_BYTE_GRAY);
				Graphics2D g = gray.createGraphics();

				g.drawImage(im, im.getMinX(), im.getMinY(), im.getWidth(), im
						.getHeight(), null);
				((TerpPaint) this.getParent()).center.setBufferedImage(gray);

				((TerpPaint) this.getParent()).changeToGray(true);
				...
				// ming 4.22 end
				// ming 4.4
				//((TerpPaint)this.getParent()).grayscaleFlag = 1;
				//}
				// ming 4.4 end
			}
			// ming 4.22
			/*	  if (colorScale.isSelected()){
			 // ming 4.4
			 //if ( ((TerpPaint)this.getParent()).grayscaleFlag == 1 ){
			 // ming 4.4 end
			 ...
			 ((TerpPaint)this.getParent()).center.setBufferedImage(cImg);

			 ((TerpPaint)this.getParent()).changeToGray( false );

			 // ming 4.4
			 //((TerpPaint)this.getParent()).grayscaleFlag = 0;
			 //}
			 // ming 4.4 end
			 }*/
			im.flush();
