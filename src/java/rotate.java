...
public class rotate extends javax.swing.JDialog {
	...
	else
	{
		...
		if ( (im.getWidth() != im.getHeight()) && (rotateFlag == 1))
		{
		    ...
		    flip90(im);
		    //((TerpPaint)this.getParent()).action_list.add("Rotate 90 degree");
		   // ((TerpPaint)this.getParent()).updateUndoList();
		}
		else
		{
		...
		*	 at.rotate(theta,(im.getWidth()/2),(im.getHeight()/2));
			...
			((TerpPaint)this.getParent()).action_list.add("Rotate 270 degree");
			((TerpPaint)this.getParent()).updateUndoList();
      //		  ((TerpPaint)this.getParent()).center.setBufferedImage(im);*/
		    }
		    else
	...
	//((TerpPaint)this.getParent()).ourCanvas.setBufferedImage(im);
	...
	at.rotate((Math.PI)/2,(((double)im.getHeight())/2),(((double)im.getHeight())/2 ) ) ;


	g.drawImage(im,at,null);
	((TerpPaint)this.getParent()).center.setBufferedImage(temp);
	 // ming 4.26
	    int cur_layer = ((TerpPaint)this.getParent()).center.currentLayer;
	    LinkedList cur_action_list = (LinkedList)(((TerpPaint)this.getParent()).action_list.get(cur_layer));
	    LinkedList cur_redo_list = (LinkedList)(((TerpPaint)this.getParent()).redo_list.get(cur_layer));
    ...
    /** This method flips the image with 270 degrees.
     * There are no OS/Hardware dependencies and no variances.	There is no need for any
     * security constraints and no references to external specifications.
     * @param im BufferedImage object to be fliped
     */
    ...
    //	{
		...
		BufferedImage temp2 = new BufferedImage(temp.getHeight(),temp.getWidth(),temp.getType());
		Graphics2D g2 = temp2.createGraphics();
		AffineTransform at2 = new AffineTransform();
		at2.rotate(((Math.PI)/2),(((double)temp.getHeight())/2),(((double)temp.getHeight())/2 ) ) ;	
		g2.drawImage(temp,at2,null);

		BufferedImage temp3 = new BufferedImage(temp2.getHeight(),temp2.getWidth(),im.getType());
		Graphics2D g3 = temp3.createGraphics();
		AffineTransform at3 = new AffineTransform();
		at3.rotate(((Math.PI)/2),(((double)temp2.getHeight())/2),(((double)temp2.getHeight())/2 ) ) ;	
		g3.drawImage(temp2,at3,null);
		
		
		((TerpPaint)this.getParent()).center.setBufferedImage(temp3);
		 // ming 4.26
	...
	cur_action_list.add("Rotate 270 degree clockwise");
