...
public class stretch extends javax.swing.JDialog {
	...
	double y1=0;
	try{
	x = Double.parseDouble(horizontal_stretch.getText());
	y = Double.parseDouble(vertical_stretch.getText());
	x1 = Double.parseDouble(horizontal_skew.getText());
	y1 = Double.parseDouble(vertical_skew.getText());
	
	
	//got all the attributes, now lets divide things up
	if(x != 100 || y!= 100|| x<0 || y <0 || x1<0|| y1<0){ //stretch performed, ignore skew
